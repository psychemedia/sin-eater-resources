...
That account had provided the basis for Hartland's more recent exposition; but could it be trusted, for eample, given the claims in *Y Cymro* that a Welsh publication from the supposed area where the tradition was extant, at the time it was supposedly still being employed, made no mention of it, or anything like it?
